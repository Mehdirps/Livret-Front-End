  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_API_URL}livret/${slug}/${id}`)
      ...
      .then((data) => {
        ...
        setModules([
          {
            data: dataModules.wifi.data,
            component: <ModuleWifi data={dataModules.wifi.data} />,
            order: dataModules.wifi.order,
          },
          {
            data: dataModules.digicode.data,
            component: <ModuleDigicode data={dataModules.digicode.data} />,
            order: dataModules.digicode.order,
          },
          {
            data: dataModules.endInfos.data,
            component: <ModuleEndInfos data={dataModules.endInfos.data} />,
            order: dataModules.endInfos.order,
          },
          {
            data: dataModules.utilsPhone.data,
            component: <ModuleUtilsPhone data={dataModules.utilsPhone.data} />,
            order: dataModules.utilsPhone.order,
          },
          {
            data: dataModules.startInfos.data,
            component: <ModuleStartInfos data={dataModules.startInfos.data} />,
            order: dataModules.startInfos.order,
          },
          {
            data: dataModules.utilsInfos.data,
            component: <ModuleUtilsInfos data={dataModules.utilsInfos.data} />,
            order: dataModules.utilsInfos.order,
          },
          {
            data: dataModules.NearbyPlaces.data,
            component: (
              <ModuleNearbyPlaces
                data={dataModules.NearbyPlaces.data}
                dataPlaces={dataModules.placeGroups.data}
              />
            ),
            order: dataModules.NearbyPlaces.order,
          },
        ]);
  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta
          name="description"
          content={`Découvrez le livret d'accueil '${livret.livret_name}' de l'établissement ${livret.establishment_name}, ${livret.description}`}
        />
      </Helmet>
