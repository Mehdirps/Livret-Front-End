    ...
    <div>
      <section>
        ...
        <p>
          ...
          du site internet{" "}
          <a href="https://heberginfos.fr" target="_blank" rel="noreferrer">
            https://heberginfos.fr
          </a>{" "}
        ...
        <ul>
          ...
          <li>
            Contact :{" "}
            <a href="mailto:mehdi.raposo77@gmail.com">
              mehdi.raposo77@gmail.com
            </a>{" "}
            / 0645686212
          </li>
          <li>Adresse : 2 RUE DE L EPEE</li>
          <li>
            Identification de l'entreprise : Mehdi Raposo au capital social de €
            - SIREN : - RCS ou RM : - Adresse postale : 2 RUE DE L EPEE
          </li>
          <li>
            Directeur de la publication : Raposo Mehdi - Contact : 0645686212
          </li>
          <li>
            Hébergeur : O2Switch - 222 Boulevard Gustave Flaubert, 63000
            Clermont-Ferrand - Téléphone : 04.44.44.60.40
          </li>
          <li>
            Délégué à la protection des données : Raposo Mehdi -{" "}
            <a href="mailto:mehdi.raposo77@gmail.com">
              mehdi.raposo77@gmail.com
            </a>
          </li>
      ...
      <section>
        ...
        <p>
          Mehdi Raposo est propriétaire des droits de propriété intellectuelle
      ...
      <section>
        ...
        <p>
          Mehdi Raposo ne pourra être tenu pour responsable des dommages directs
        ...
        <p>
          Mehdi Raposo décline toute responsabilité quant à l’utilisation qui
        ...
        <p>
          Mehdi Raposo s’engage à sécuriser au mieux le site, cependant sa
        ...
        <p>
          ...
          disposition des utilisateurs. Mehdi Raposo se réserve le droit de
        ...
        <p>
          Le cas échéant, Mehdi Raposo se réserve également la possibilité de
      ...
      <section>
        ...
        <p>
          ...
          notre Délégué à la Protection des Données : Raposo Mehdi -{" "}
          <a href="mailto:mehdi.raposo77@gmail.com">mehdi.raposo77@gmail.com</a>
          .
        </p>
        <p>
          ...
          <a
            href="https://heberginfos.fr/politiques-confidentialitées"
            target="_blank"
            rel="noreferrer"
          >
