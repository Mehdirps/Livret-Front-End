...
const ModuleStartInfos = ({data}) => {
    ...
    return (
        <div className="modal fade" id="startInfosModal" tabIndex="-1" aria-labelledby="startInfosModalLabel"
             aria-hidden="true">
            <div className="modal-dialog">
                <div className="modal-content">
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="wifiModalLabel">Ajouter une info d'arrivée</h5>
