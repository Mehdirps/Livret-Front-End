...
const ModuleUtilsInfos = ({data}) => {
    ...
    return (
        <div className="modal fade" id="utilsInfosModal" tabIndex="-1" aria-labelledby="utilsInfosModalLabel"
             aria-hidden="true">
            <div className="modal-dialog">
                <div className="modal-content">
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="wifiModalLabel">Ajouter une info utile</h5>
                            ...
                            <div className="modal-body">
                                <form id="wifiForm" onSubmit={(e) => addModuleUtilsInfo(e)}>
                                    <div className="mb-3">
                                        <label for="sub_name" className="form-label">Nom</label>
                                        <input type="text" className="form-control" id="sub_name" name="sub_name" required
                                               onChange={(e) => setSubName(e.target.value)}/>
                                    </div>
                                    <div className="mb-3">
                                        <label for="text" className="form-label">Texte</label>
                                        <textarea className="form-control" id="text" name="text" required
