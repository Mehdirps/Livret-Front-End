    ...
    <>
      ...
      >
        ...
        <NavLink
          onClick={() => toggleSidebar()}
          to="/dashboard"
          className="d-flex flex-column align-items-center mb-3 mb-md-0 text-white text-decoration-none"
        >
            ...
            <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              {livret && (
                <li>
                  <Link
                    className="dropdown-item"
                    to={`/livret/${livret.slug}/${livret.id}`}
                    target="_blank"
                  >
                    Voir
                  </Link>
