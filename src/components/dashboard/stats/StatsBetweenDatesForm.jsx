            ...
            {statsDatas && (
                <div className="card text-white bg-dark mb-3 mt-3">
                    ...
                    <div className="card-body">
                        <h5 className="card-title">Du {statsDatas.startDate} au {statsDatas.endDate}</h5>
                        <p className="card-text">Nombre de vues : {statsDatas.viewsBetweenDates}</p>
                    </div>
                </div>
            )}
            <div className="row">
                <div className="col-md-12">
                    ...
                    <form onSubmit={(e) => handleSubmit(e)}>
                        ...
                        <button type="submit" className="btn btn-primary">Voir les statistiques</button>
                    </form>
                </div>
            </div>
        </>
