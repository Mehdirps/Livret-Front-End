...
const LivretProfileForm = () => {
  ...
  return (
    <div className="col-12">
      <form
        id="update-livret-form"
        onSubmit={handleSubmit}
        className="p-5 bg-light rounded"
        encType="multipart/form-data"
      >
        <h3>
          <i className="bi bi-info-circle"></i> Les informations du livret
        </h3>
        <div className="form-group">
          <label htmlFor="livret_name" className="form-label">
            <i className="bi bi-building"></i>Nom du livret
          </label>
          <input
            type="text"
        ...
        <div className="form-group">
          <label htmlFor="description" className="form-label">
            <i className="bi bi-clipboard"></i> Description du livret
          </label>
          <textarea
            className="form-control"
            id="description"
        ...
        <div className="row">
          <div className="col-md-6">
            <div className="form-group mb-3">
              <label htmlFor="establishment_name" className="form-label">
                <i className="bi bi-building"></i> Nom de l'établissement
              </label>
              <input
                type="text"
                className="form-control"
          ...
          <div className="col-md-6">
            <div className="form-group mb-3">
              <label htmlFor="establishment_address" className="form-label">
                <i className="bi bi-geo-alt"></i> Adresse de l'établissement
              </label>
              <input
                type="text"
                className="form-control"
        ...
        <div className="row">
          <div className="col-md-6">
            <div className="form-group mb-3">
              <label htmlFor="establishment_phone" className="form-label">
                <i className="bi bi-telephone"></i> Téléphone de l'établissement
              </label>
              <input
                type="text"
                className="form-control"
          ...
          <div className="col-md-6">
            <div className="form-group mb-3">
              <label htmlFor="establishment_email" className="form-label">
                <i className="bi bi-envelope"></i> Email de l'établissement
              </label>
              <input
                type="email"
                className="form-control"
        ...
        <div className="row">
          <div className="col-md-6">
            <div className="form-group mb-3">
              <label htmlFor="establishment_website" className="form-label">
                <i className="bi bi-globe"></i> Site web de l'établissement
              </label>
              <input
                type="text"
                className="form-control"
                id="establishment_website"
          ...
          <div className="col-md-6">
            <div className="form-group mb-3">
              <label htmlFor="instagram" className="form-label">
                <i className="bi bi-instagram"></i> Lien Instagram
              </label>
              <input
                type="text"
                className="form-control"
          ...
          <div className="col-md-6">
            <div className="form-group mb-3">
              <label htmlFor="facebook" className="form-label">
                <i className="bi bi-facebook"></i> Lien Facebook
              </label>
              <input
                type="text"
                className="form-control"
          ...
          <div className="col-md-6">
            <div className="form-group mb-3">
              <label htmlFor="linkedin" className="form-label">
                <i className="bi bi-linkedin"></i> Lien Linkedin
              </label>
              <input
                type="text"
                className="form-control"
        ...
        <div className="row">
          <div className="col-md-6">
            <div className="form-group mb-3">
              <label htmlFor="twitter" className="form-label">
                <i className="bi bi-twitter"></i> Lien Twitter/X
              </label>
              <input
                type="text"
                className="form-control"
          ...
          <div className="col-md-6">
            <div className="form-group mb-3">
              <label htmlFor="tripadvisor" className="form-label">
                <i className="bi bi-link"></i> Lien Tripadvisor
              </label>
              <input
                type="text"
                className="form-control"
        ...
        <div className="form-group">
          ...
          <label htmlFor="logo" className="form-label">
            <i className="bi bi-image"></i> Logo de l'établissement
          </label>
          <input
            type="file"
            className="form-control"
