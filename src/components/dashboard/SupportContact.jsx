  ...
  return (
    <>
      <button
        ...
        data-bs-target="#supportContactModal"
      >
      ...
      <>
        {open && (
          <div
            ...
            id="supportContactModal"
            tabIndex="-1"
            aria-labelledby="supportContactModalLabel"
            aria-hidden="true"
            data-testid="support-contact-modal"
          >
            <div className="modal-dialog">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title" id="supportContactModalLabel">
                    Contacter le support
                  </h5>
                  <button
                    type="button"
