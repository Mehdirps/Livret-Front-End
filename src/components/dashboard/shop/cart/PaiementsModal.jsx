...
const stripePromise = loadStripe(
  "pk_test_51PpBnpIXFdsl2Ez7ChX5PyzWowJXyUtPm7xIgF6yesuJS1MwGVgMyzeVHIdW7tkALTce6TwGX1MG48BMqWwtDHHJ00TouExlWZ"
);
...
const PaiementsModal = ({ calculateTotal }) => {
  ...
  return (
    <div
      ...
      id="paiementsModal"
      tabIndex="-1"
      aria-labelledby="paiementsModalLabel"
      aria-hidden="true"
    >
      <div className="modal-dialog modal-lg">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="paiementsModalLabel">
