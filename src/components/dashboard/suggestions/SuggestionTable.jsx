      ...
      <table className="table table-striped">
        ...
        <tbody>
          {suggestions.map((suggestion) => (
            <tr data-status={suggestion.status} className="tr_data" key={suggestion.id}>
              ...
              <td>
                ...
                >
                  <option
                    value="pending"
                    selected={suggestion.status === "pending"}
                  >
                    En attente
                  </option>
                  <option
                    value="accepted"
                    selected={suggestion.status === "accepted"}
                  >
                    Accepté
                  </option>
                  <option
                    value="refused"
                    selected={suggestion.status === "refused"}
                  >
                    Refusé
                  </option>
                </select>
