          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              >
                ...
                <div className="mb-3">
                  <label htmlFor="client_comment" className="form-label">
                ...
                <div className="mb-3">
                  <label htmlFor="attachment_names" className="form-label">
                    Pièces jointes
                  </label>
                  <input
                    type="file"
                  ...
                  <div id="filesHelp" className="form-text">
                    Vous pouvez sélectionner plusieurs fichiers. Seuls les
                    fichiers .pdf, .png, .jpeg, .webp, .jpg, .xlsx, .xls, .doc,
                    .docx, .odt, .ods, .ppt, .pptx sont autorisés.
                  </div>
                </div>
                <input
                  type="submit"
