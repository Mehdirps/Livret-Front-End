  ...
  return (
    <div className="container">
        ...
        onSubmit={(e) => {
          ...
          if (confirmPassword === "" || confirmPassword !== password) {
            setConfirmPasswordError(
              "La confirmation du mot de passe est obligatoire et doit être identique au mot de passe"
            );
            return;
          } else {
            setConfirmPasswordError("");
      ...
      >
        ...
        <div className="mb-3">
          <label htmlFor="etablissement_type" className="form-label">
          ...
          >
            <option selected disabled>
              -- Choisir un type d'établissement --
            </option>
